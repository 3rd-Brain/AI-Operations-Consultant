...
<!--
Template for a role document inside the per-company library.
Created by the AI Ops Consultant V2 when the user scopes a role.
Lives at roles/<role-slug>.md in the company library.

Two deliverable sections:
  - Role Responsibilities: the work itself, organized by cadence
  - KOODAR Breakdown: per-role documentation of all six capability areas

Tools and data named INLINE inside responsibility steps.
Workflow expansion lives in workflows/<workflow-slug>.md — linked, not duplicated.
...
### A — Act
- <standard procedures for core responsibilities — pointers to workflows/>
